...
$pageTitle = "Culturama - Ajouter un film";
...
<div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md mx-auto mt-10">
    <h1 class="text-2xl font-bold mb-6 text-center text-gray-800">Ajouter un film</h1>
    <form method="post" action="/movie/add" enctype="multipart/form-data" class="space-y-4">
        <div>
        ...
        <div>
            ...
            value="<?= $_POST['movieDuration']??""?>">
        </div>
        <div>
            <?php $selectedGenre = $_POST['movieGenre'] ?? ''; ?>
        ...
        <div class="text-center">
            <input type="submit" value="Ajouter le film" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 cursor-pointer font-semibold">
        </div>
