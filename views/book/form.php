<?php
$pageTitle = "Culturama - Ajouter un livre";
...
<div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md mx-auto mt-10">
    ...
    <form method="post" action="/book/add" enctype="multipart/form-data" class="space-y-4">
        <div>
